...
export function SiteHeader() {
  ...
  function logout() { localStorage.removeItem('gearup_user'); localStorage.removeItem('gearup_token'); document.cookie='gearup_session=; path=/; max-age=0; samesite=lax'; setUser(null); }
